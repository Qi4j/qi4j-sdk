...
public class DocumentationSupport
{
    ...
    public static class pancake
    {
        ...
        {
            return qi4j.newApplicationModel(factory -> factory.newApplicationAssembly(assemblers));
        }
        // END SNIPPET: pancake
    }
    ...
    public static class full
    {
            ...
            throws Exception
        {
            ...
            application = qi4j.newApplication(factory -> buildAssembly(factory.newApplicationAssembly()));
            // Activate the application
            application.activate();
        }

        static ApplicationAssembly buildAssembly(ApplicationAssembly app)
            throws AssemblyException
        {
        ...
        private static void createMessagingPersistenceModule(LayerAssembly layer)
            throws AssemblyException
        {
        }
    }
