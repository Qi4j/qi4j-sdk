...
// START SNIPPET: application2
            ...
            Application app = qi4j.newApplication( factory -> factory.newApplicationAssembly( assemblers ) );
            app.activate();
// END SNIPPET: application2
        ...
        throws Exception
    {
        ...
        ApplicationDescriptor model = qi4j.newApplicationModel( factory -> createAssembly( factory ) );
