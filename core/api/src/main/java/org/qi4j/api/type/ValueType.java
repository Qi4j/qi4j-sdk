...
public class ValueType implements HasTypes
{
    ...
    private List<Class<?>> applyPrimitiveAndBoxedTypes(List<Class<?>> types)
    {
        ...
        if(charPrimitiveIndex >= 0 && charBoxedIndex == -1)
        {
            allTypes.add(Character.class);
        }
        if(charPrimitiveIndex == -1 && charBoxedIndex >= 0)
        {
            allTypes.add(char.class);
        }
        if(boolPrimitiveIndex >= 0 && boolBoxedIndex == -1)
        {
            allTypes.add(Boolean.class);
        }
        if(boolPrimitiveIndex == -1 && boolBoxedIndex >= 0)
        {
            allTypes.add(boolean.class);
        }
        if(intPrimitiveIndex >= 0 && intBoxedIndex == -1)
        {
            allTypes.add(Integer.class);
        }
        if(intPrimitiveIndex == -1 && intBoxedIndex >= 0)
        {
            allTypes.add(int.class);
        }
        if(shortPrimitiveIndex >= 0 && shortBoxedIndex == -1)
        {
            allTypes.add(Short.class);
        }
        if(shortPrimitiveIndex == -1 && shortBoxedIndex >= 0)
        {
            allTypes.add(short.class);
        }
        if(longPrimitiveIndex >= 0 && longBoxedIndex == -1)
        {
            allTypes.add(Long.class);
        }
        if(longPrimitiveIndex == -1 && longBoxedIndex >= 0)
        {
            allTypes.add(long.class);
        }
        if(bytePrimitiveIndex >= 0 && byteBoxedIndex == -1)
        {
            allTypes.add(Byte.class);
        }
        if(bytePrimitiveIndex == -1 && byteBoxedIndex >= 0)
        {
            allTypes.add(byte.class);
        }
        if(floatPrimitiveIndex >= 0 && floatBoxedIndex == -1)
        {
            allTypes.add(Float.class);
        }
        if(floatPrimitiveIndex == -1 && floatBoxedIndex >= 0)
        {
            allTypes.add(float.class);
        }
        if(doublePrimitiveIndex >= 0 && doubleBoxedIndex == -1)
        {
            allTypes.add(Double.class);
        }
        if(doublePrimitiveIndex == -1 && doubleBoxedIndex >= 0)
        {
            allTypes.add(double.class);
        }
        return allTypes;
