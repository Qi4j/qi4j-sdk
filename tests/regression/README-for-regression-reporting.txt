...
1. Go to https://github.com/Qi4j/qi4j-sdk/issues/ and create a new issue about the problem.
...
3. Create a JUnit or TestNG test capturing the issue described in the issue.

4. Commit and push this to the 'origin develop' branch.

5. Ping the community on the qi4j-dev@googlegroups.com mailing list.
