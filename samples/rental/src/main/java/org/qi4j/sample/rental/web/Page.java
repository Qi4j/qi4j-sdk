    ...
    extends ServiceComposite
{
        ...
        implements Page
    {
        ...
        private void execute(QuikitContext context, Element element, Element parent)
            throws RenderException
        {
            Stream<Class<?>> types = Qi4jAPI.FUNCTION_DESCRIPTOR_FOR.apply(context.page()).types();
            Class<?> compositeType = types.findFirst().orElse(null);
...
//                }
        ...
        private Method findMethod(String methodName, Class<?> compositeType)
