...
import org.qi4j.index.opensearch.filesystem.OpenSearchFilesystemIndexQueryService;
import org.qi4j.index.opensearch.internal.AbstractOpenSearchAssembler;

public class OpenSearchFilesystemIndexQueryAssembler
    extends AbstractOpenSearchAssembler<OpenSearchFilesystemIndexQueryAssembler>
{
    @Override
    public void assemble( ModuleAssembly module )
    {
        super.assemble( module );
        module.services( OpenSearchFilesystemIndexQueryService.class )
