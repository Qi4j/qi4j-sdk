...
@ExtendWith( { TemporaryFolder.class,
               TestName.class } )
public class OpenSearchQueryTest extends AbstractQueryTest
{
    ...
    @Disabled(
        "OpenSearch perform automatic TimeZone resolution when querying on dates, this test assert that the underlying Index/Query engine do not."
    )
    @Test
    @Override
