...
public interface CassandraEntityStoreConfiguration
{
     ...
     *
     * @return The configured cluster name. Default: "qi4j-cluster"
     */
    @Optional
     ...
     *
     * @return The name of the KEYSPACE to use If null, then the default <code>KEYSPACE qi4j</code> will be used.
     */
    @UseDefaults
