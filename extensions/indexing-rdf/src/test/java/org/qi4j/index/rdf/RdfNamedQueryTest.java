...
// START SNIPPET: query1
        "PREFIX ns0: <urn:qi4j:type:org.qi4j.api.identity.HasIdentity#> \n"
            + "PREFIX rdf: <http://www.w3.org/1999/02/22-rdf-syntax-ns#> \n"
            + "PREFIX rdfs: <http://www.w3.org/2000/01/rdf-schema#> \n" + "SELECT DISTINCT ?reference\n"
            + "WHERE {\n" + "?entityType rdfs:subClassOf <urn:qi4j:type:org.qi4j.test.model.Person>. \n"
            + "?entity rdf:type ?entityType. \n" + "?entity ns0:identity ?reference. \n" + "\n" + "}", // script01
// END SNIPPET: query1

// START SNIPPET: query2
        "PREFIX ns1: <urn:qi4j:type:org.qi4j.test.model.Nameable#> \n"
            + "PREFIX ns0: <urn:qi4j:type:org.qi4j.api.identity.HasIdentity#> \n"
            + "PREFIX rdf: <http://www.w3.org/1999/02/22-rdf-syntax-ns#> \n"
            + "PREFIX rdfs: <http://www.w3.org/2000/01/rdf-schema#> \n" + "SELECT DISTINCT ?reference\n"
            + "WHERE {\n" + "?entityType rdfs:subClassOf <urn:qi4j:type:org.qi4j.test.model.Domain>. \n"
            + "?entity rdf:type ?entityType. \n" + "?entity ns0:identity ?reference. \n" + "?entity ns1:name ?v0. \n"
            + "FILTER (?v0 = \"Gaming\")\n" + "}", // script02
// END SNIPPET: query2
...
// START SNIPPET: query3
        "PREFIX ns0: <urn:qi4j:type:org.qi4j.api.identity.HasIdentity#> \n"
            + "PREFIX rdf: <http://www.w3.org/1999/02/22-rdf-syntax-ns#> \n"
            + "PREFIX rdfs: <http://www.w3.org/2000/01/rdf-schema#> \n" + "SELECT DISTINCT ?reference\n"
            + "WHERE {\n" + "?entityType rdfs:subClassOf <urn:qi4j:type:org.qi4j.test.model.Nameable>. \n"
            + "?entity rdf:type ?entityType. \n" + "?entity ns0:identity ?reference. \n" + "\n" + "}", // script03
// END SNIPPET: query3

// START SNIPPET: query4
        "PREFIX ns1: <urn:qi4j:type:org.qi4j.test.model.Person#> \n"
            + "PREFIX ns2: <urn:qi4j:type:org.qi4j.test.model.Nameable#> \n"
            + "PREFIX ns0: <urn:qi4j:type:org.qi4j.api.identity.HasIdentity#> \n"
            + "PREFIX rdf: <http://www.w3.org/1999/02/22-rdf-syntax-ns#> \n"
            + "PREFIX rdfs: <http://www.w3.org/2000/01/rdf-schema#> \n" + "SELECT DISTINCT ?reference\n"
            + "WHERE {\n" + "?entityType rdfs:subClassOf <urn:qi4j:type:org.qi4j.test.model.Person>. \n"
...
// START SNIPPET: query9
        "PREFIX ns1: <urn:qi4j:type:org.qi4j.test.model.Person#> \n"
            ...
            + "PREFIX rdf: <http://www.w3.org/1999/02/22-rdf-syntax-ns#> \n"
            + "PREFIX rdfs: <http://www.w3.org/2000/01/rdf-schema#> \n" + "SELECT DISTINCT ?reference\n"
            + "WHERE {\n" + "?entityType rdfs:subClassOf <urn:qi4j:type:org.qi4j.test.model.Female>. \n"
            + "?entity rdf:type ?entityType. \n" + "?entity ns0:identity ?reference. \n"
            + "?entity ns1:yearOfBirth ?v0. \n" + "FILTER ((?v0 = \"1970\") || (?v0 = \"1975\"))\n" + "}", // script09
// END SNIPPET: query9
...
// START SNIPPET: query13
        "PREFIX ns0: <urn:qi4j:type:org.qi4j.api.identity.HasIdentity#> \n"
            + "PREFIX rdf: <http://www.w3.org/1999/02/22-rdf-syntax-ns#> \n"
            + "PREFIX ns1: <urn:qi4j:type:org.qi4j.test.model.Male#> \n"
            + "PREFIX rdfs: <http://www.w3.org/2000/01/rdf-schema#> \n" + "SELECT DISTINCT ?reference\n"
            + "WHERE {\n" + "?entityType rdfs:subClassOf <urn:qi4j:type:org.qi4j.test.model.Person>. \n"
            + "?entity rdf:type ?entityType. \n" + "?entity ns0:identity ?reference. \n"
...
// START SNIPPET: query14
        "PREFIX ns0: <urn:qi4j:type:org.qi4j.api.identity.HasIdentity#> \n"
            ...
            + "PREFIX ns1: <urn:qi4j:type:org.qi4j.test.model.Male#> \n"
            + "PREFIX rdfs: <http://www.w3.org/2000/01/rdf-schema#> \n" + "SELECT DISTINCT ?reference\n"
            + "WHERE {\n" + "?entityType rdfs:subClassOf <urn:qi4j:type:org.qi4j.test.model.Male>. \n"
            + "?entity rdf:type ?entityType. \n" + "?entity ns0:identity ?reference. \n"
            + "OPTIONAL {?entity ns1:wife ?v0}. \n" + "FILTER (! bound(?v0))\n" + "}", // script14
// END SNIPPET: query14
