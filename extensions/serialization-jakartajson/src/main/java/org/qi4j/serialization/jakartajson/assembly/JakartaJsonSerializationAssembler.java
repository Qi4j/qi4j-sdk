 ...
 */
package org.qi4j.serialization.jakartajson.assembly;
...
import org.qi4j.serialization.jakartajson.JakartaJsonSettings;
...
public class JakartaJsonSerializationAssembler extends Assemblers.VisibilityIdentity<JakartaJsonSerializationAssembler>
{
    private JakartaJsonSettings settings;

    public JakartaJsonSerializationAssembler withJsonSettings(JakartaJsonSettings settings )
    {
    ...
    public void assemble( ModuleAssembly module )
    {
        ...
        ServiceDeclaration declaration = module.services( JakartaJsonSerialization.class )
                                               .withTypes( Serialization.class,
                                                           Serializer.class, Deserializer.class,
                                                           Converters.class,
                                                           JsonSerialization.class,
                                                           JsonSerializer.class, JsonDeserializer.class,
                                                           JakartaJsonFactories.class, JakartaJsonAdapters.class )
