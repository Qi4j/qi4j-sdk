...
import org.qi4j.test.serialization.AbstractPlainValueSerializationTest;

public class JakartaJsonPlainValueSerializationTest extends AbstractPlainValueSerializationTest
{
    @Override
    public void assemble( final ModuleAssembly module )
    {
        new JakartaJsonSerializationAssembler()
            .withJsonSettings( withTestSettings( new JakartaJsonSettings() ) )
            .assemble( module );
    }
