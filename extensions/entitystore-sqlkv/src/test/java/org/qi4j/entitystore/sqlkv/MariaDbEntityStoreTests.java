...
@Testcontainers
public class MariaDbEntityStoreTests extends EntityStoreTestSuite
{
    @Container
    ...
    protected void defineStorageModule(ModuleAssembly module)
    {
        ...
        defaults.url().set(mariaDBContainer.getJdbcUrl()
        ...
        defaults.driver().set(mariaDBContainer.getDriverClassName());
