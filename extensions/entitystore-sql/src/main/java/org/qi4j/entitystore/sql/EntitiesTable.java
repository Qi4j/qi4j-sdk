...
import static org.qi4j.entitystore.sql.MixinTable.INDEX_COLUMN_NAME;
import static org.qi4j.entitystore.sql.MixinTable.NAME_COLUMN_NAME;
import static org.qi4j.entitystore.sql.MixinTable.REFERENCE_COLUMN_NAME;
import static org.qi4j.entitystore.sql.SqlType.makeField;
...
public class EntitiesTable
{
                   ...
                   Serialization serialization )
    {
        ...
        valueIdentityColumn = SqlType.makeField( VALUEID_COLUMN_NAME, String.class, dialect );
        typeNameColumn = SqlType.makeField( TYPE_COLUMN_NAME, String.class, dialect );
        versionColumn = SqlType.makeField( VERSION_COLUMN_NAME, String.class, dialect );
        applicationVersionColumn = SqlType.makeField( APPLICATIONVERSION_COLUMN_NAME, String.class, dialect );
    }
