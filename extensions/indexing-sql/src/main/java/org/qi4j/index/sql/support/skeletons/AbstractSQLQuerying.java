...
import org.qi4j.library.sql.generator.grammar.common.SQLFunctions;
...
import org.qi4j.library.sql.generator.grammar.query.ColumnReference;
...
import org.qi4j.library.sql.generator.grammar.query.joins.JoinType;
    ...
    implements SQLQuerying
{
    ...
    )
    {
        ...
        else if( value instanceof ValueComposite )
        {
            ...
            // @formatter:off
            Qi4jAPI.FUNCTION_COMPOSITE_INSTANCE_OF.apply( (ValueComposite) value )
                .state().properties()
                .forEach( property -> {
