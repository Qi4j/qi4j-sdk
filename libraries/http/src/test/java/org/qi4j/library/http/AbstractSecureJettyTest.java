    ...
    extends AbstractJettyTest
{
    ...
    protected static final String CLIENT_KEYSTORE_FILENAME = "qi4j-lib-http-unittests-client-cert.jceks";
    protected static final String SERVER_KEYSTORE_FILENAME = "qi4j-lib-http-unittests-server-cert.jceks";
    protected static final String TRUSTSTORE_FILENAME = "qi4j-lib-http-unittests-ca.jceks";
