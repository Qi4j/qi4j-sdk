    ...
    implements TemplateHashModelEx, TemplateScalarModel
{
    ...
    public ValueCompositeTemplateModel( ValueComposite composite, ObjectWrapper wrapper )
    {
        ...
        descriptor = (ValueDescriptor) Qi4jAPI.FUNCTION_DESCRIPTOR_FOR.apply( composite );
    }
    ...
    public TemplateCollectionModel values()
        throws TemplateModelException
    {
        List<Object> values = Qi4jAPI.FUNCTION_COMPOSITE_INSTANCE_OF.apply( composite )
                                                                    .state().properties()
        ...
        throws TemplateModelException
    {
        try
        {
            return wrapper.wrap( Qi4jAPI.FUNCTION_COMPOSITE_INSTANCE_OF
                                     .apply( composite )
                                     .state()
